 ...
 <link rel="stylesheet" href="layout/css/all.min.css">
    ...
    <script>
      document.addEventListener("DOMContentLoaded", () => {
        ...
        scriptEl.setAttribute("src", "layout/js/reservation.js");
...
<div class="card shadow mb-5 mt-5  rounded" >
    ...
    <div class="card-body" id="addProperty">
        ...
        <form action="../controller/reserv.php" method="POST">
            ...
            <!-- Sweet Alert -->
            <?php
                if(isset($_SESSION['prixfinal']) && $_SESSION['prixfinal']!=0 ){

            ?>
            <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
            <script>
                Swal.fire('Your Reservation Is Successfully <br> The total price is :  <?php echo $_SESSION['prixfinal']?> DH')
            </script>
            <?php
                unset($_SESSION['prixfinal']);
                }
            ?>
